...
bonus[""]={cn:"最大行动力",en:"MAX AP"};
bonus[""]={cn:"最大移动力",en:"MAX MP"};
bonus[""]={cn:"最大创生力",en:"MAX WP"};
bonus[""]={cn:"最大生命",en:"MAX HP"};
bonus[""]={cn:"行动力",en:"AP"};
bonus[""]={cn:"移动力",en:"MP"};
bonus[""]={cn:"创生力",en:"WP"};
bonus[""]={cn:"生命",en:"HP"};
bonus[""]={cn:"武器伤害",en:"Damage"};
bonus[""]={cn:"统率",en:"Control"};
bonus[""]={cn:"射程",en:"Range"};
bonus[""]={cn:"先手",en:"Initiative"};
bonus[""]={cn:"格挡",en:"Block"};
bonus[""]={cn:"闪避",en:"Dodge"};
bonus[""]={cn:"锁定",en:"Lock"};
bonus[""]={cn:"伤害",en:"Mastery of"};
bonus[""]={cn:"熟练",en:"Kit Skill"};
bonus[""]={cn:"暴击",en:"Critical Hit"};
bonus[""]={cn:"暴击伤害",en:"Critical Mastery"};
bonus[""]={cn:"单体伤害",en:"Single Target Mastery"};
bonus[""]={cn:"范围伤害",en:"Area Mastery"};
bonus[""]={cn:"远程伤害",en:"Distance Mastery"};
bonus[""]={cn:"近战伤害",en:"Melee Mastery"};
bonus[""]={cn:"狂暴伤害",en:"Berserk Mastery"};
bonus[""]={cn:"背刺伤害",en:"Rear Mastery"};
bonus[""]={cn:"治疗",en:"Healing Mastery"};
bonus[""]={cn:"种随机元素",en:"random elements"};
bonus[""]={cn:"种随机元素",en:"random element"};
bonus[""]={cn:"元素抗性",en:"Elemental Resistance"};
bonus[""]={cn:"暴击抗性",en:"Critical Resistance"};
bonus[""]={cn:"单体抗性",en:"Single Target Resistance"};
bonus[""]={cn:"范围抗性",en:"Area Resistance"};
bonus[""]={cn:"远程抗性",en:"Distance Resistance"};
bonus[""]={cn:"近战抗性",en:"Melee Resistance"};
bonus[""]={cn:"狂暴抗性",en:"Berserk Resistance"};
bonus[""]={cn:"背刺抗性",en:"Rear Resistance"};
bonus[""]={cn:"火抗",en:"Resistance Fire"};
bonus[""]={cn:"水抗",en:"Resistance Water"};
bonus[""]={cn:"风抗",en:"Resistance Air"};
bonus[""]={cn:"土抗",en:"Resistance Earth"};
bonus[""]={cn:"抗性",en:"Resistance to"};
bonus[""]={cn:"护甲获得",en:"Armor received"};
bonus[""]={cn:"护甲给予",en:"Armor given"};
